...
use App\Contracts\User\DetailProduct as ContractsDetail; // set để sử dụng 
...
class DetailProductEloquentRepository extends EloquentRepository implements ContractsDetail
{
    ...
    public function getdetailPro($lst_GET)
    {
        $lst = $lst_GET;
